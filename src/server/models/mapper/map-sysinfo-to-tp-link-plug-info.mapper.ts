import { TpLinkPlugInfoDto } from '../devices/tp-link-plug-info.dto';
...
export const mapSysinfoToTPLinkPlugInfo = (sysInfo: PlugInfo, isActive: boolean, id: string): TpLinkPlugInfoDto => ({
    id,
